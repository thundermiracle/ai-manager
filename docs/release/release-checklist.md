...
3. Review the open Release PR generated by `release-please`.
4. Create release notes from template and include:
   - highlights
   - compatibility notes
   - known issues
5. Merge the Release PR to create tag `vX.Y.Z` and publish the GitHub Release.
6. Confirm the macOS packaging workflow attached release assets (`.dmg` and manifest).
